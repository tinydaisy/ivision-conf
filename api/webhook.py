...
async def start(message: types.Message):
    ...
    url = build_url(LANDING_URL, new_partner_id=utm_params.get("new_partner_id", ""),
                    utm_source=utm_params.get("utm_source", ""), tg_id=tg_id)
    ...
    await message.answer(
        ...
        f"Нажми кнопку ниже, чтобы открыть страницу {CONFERENCE_NAME}.",
